class Generator(BaseGenerator):
    ...
    def data(self):
        ...
        while dummy0 < 0:
            weirdvec = [1,0,0 ]
            tempV = [0, randrange(1,4),randrange(1,4)]
            InitialA[0] = tempV.copy()
            point = [randrange(1,4), randrange(1,4), randrange(1,4), ]
            InitialA[1] = [randrange(1,4)*(-1), randrange(-3,4), randrange(1,4), ].copy()
            InitialA[2] = [randrange(1,4)*(-1), randrange(1,4), randrange(-3,4), ].copy()

            dummy0 = min([InitialA[2][0]*point[0]+InitialA[2][1]*point[1]+InitialA[2][2]*point[2] , InitialA[1][0]*point[0]+InitialA[1][1]*point[1]+InitialA[1][2]*point[2]])  
        ...
        InitialC = [randrange(-3,0),randrange(-3,0),randrange(-3,0)]
        ...
        V = self.simplexpivot(InitialA,InitialB,InitialC,InitialD,0,0).copy()
        InitialA[0] = V[0][0].copy()
        InitialA[1] = V[0][1].copy()
        InitialA[2] = V[0][2].copy()
        InitialB = V[1].copy()
        ...
        InitialC = [randrange(1,4),randrange(-3,0),randrange(-3,0)]
