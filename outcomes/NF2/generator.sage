    ...
    def data(self):
        ...
        while V1 != V1temp:
            ...
            for i in V1:
                for j in V2:
                    if i == s and j == 1:
                        if ( P.get_values(x[s,1]) < cs1 ) and (1 in V2temp):
                            V1temp.append(1)
                            V2temp.remove(1)
                    if i == s and j == 2:
                        if ( P.get_values(x[s,2]) < cs1) and (2 in V2temp):
                            V1temp.append(2)
                            V2temp.remove(2)
                    if i == 1 and j == 2:
                        if (( P.get_values(x[1,2]) < c12) or (P.get_values(x[2,1])>0) ) and (2 in V2temp):
                            V1temp.append(2)
                            V2temp.remove(2)
                    if i == 2 and j == 1:
                        if (( P.get_values(x[2,1]) < c21) or (P.get_values(x[1,2])>0) ) and (1 in V2temp):
                            V1temp.append(1)
                            V2temp.remove(1)
                    if i == 1 and j == 3:
                        if (( P.get_values(x[1,3]) < c13) or ( P.get_values(x[3,1])>0) ) and (3 in V2temp):
                            V1temp.append(3)
                            V2temp.remove(3)
                    if i == 3 and j == 1:
                        if ((x[3,1] < c31) or (x[1,3]>0) ) and (1 in V2temp):
                            ...
                            V2temp.remove(1)
                    if i == 1 and j == 4:
                        if (( P.get_values(x[1,4]) < c14) or ( P.get_values(x[4,1])>0) ) and (4 in V2temp):
                            V1temp.append(4)
                            V2temp.remove(4)
                    if i == 4 and j == 1:
                        if (( P.get_values(x[4,1]) < c41) or ( P.get_values(x[1,4]) > 0) ) and (1 in V2temp):
                            V1temp.append(1)
                            V2temp.remove(1) 
                    if i == 2 and j == 3:
                        if (( P.get_values(x[2,3]) < c23) or ( P.get_values(x[3,2]) >0) ) and (3 in V2temp):
                            V1temp.append(3)
                            V2temp.remove(3) 
                    if i == 3 and j == 2:
                        if (( P.get_values(x[3,2]) < c32) or ( P.get_values(x[2,3])>0) ) and (2 in V2temp):
                            V1temp.append(2)
                            V2temp.remove(2)
                    if i == 2 and j == 4:
                        if (( P.get_values(x[2,4]) < c24) or ( P.get_values(x[4,2]) >0) ) and (4 in V2temp):
                            V1temp.append(4)
                            V2temp.remove(4) 
                    if i == 4 and j == 2:
                        if (( P.get_values(x[4,2]) < c42) or ( P.get_values(x[2,4]) >0) ) and (2 in V2temp):
                            V1temp.append(2)
                            V2temp.remove(2)
                    if i == 3 and j == 4:
                        if (( P.get_values(x[3,4]) < c24) or ( P.get_values(x[4,3]) >0) ) and (4 in V2temp):
                            V1temp.append(4)
                            V2temp.remove(4) 
                    if i == 4 and j == 3:
                        if (( P.get_values(x[4,3]) < c43) or ( P.get_values(x[3,4]) >0) ) and (3 in V2temp):
                            V1temp.append(3)
                            V2temp.remove(3)                                                                                     
